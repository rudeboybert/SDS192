...
* **Getting help**:
    ...
    + Spinelli Center [SDS drop-in tutoring hours](https://www.smith.edu/qlc/tutoring.html?colStats=open#PanelStats.){target="_blank"}. In Sabin-Reed 301
        ...
        + Friday 2:35-3:30pm
    + Office hours:
        + Office hours times will change. The most up-to-date location and time info will be posted in this [calendar](https://calendar.google.com/calendar/embed?src=c_hoe7p7ku3rhppoot8e38mponpo%40group.calendar.google.com&ctz=America%2FToronto){target="_blank"}. Before coming to office hours, please have your question ready on your computer. 
