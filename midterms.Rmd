...
* Notes for after exam:
    + Be sure to timestamp your exam before returning. **Timestamps will be strictly enforced. Any timestamps indicating than more than 140 minutes are subject to a 50% penalty and an honor board case.**
