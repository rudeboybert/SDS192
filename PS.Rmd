...
1. Complete a syllabus quiz.
    + Open the following [Google Doc](https://docs.google.com/document/d/1WknUhbtDeTGw8vvO8ytTURkF1_72ve4UXF5-SPk5NO8/){target="_blank"} and click "File -> Make a copy"
...
1. Submit a PDF of your syllabus quiz responses on gradescope:
    ...
    + **Added after lecture**: You need to "tag" the 11 individual questions on whatever page they are on (demo on Fri 9/10)
