...
* Upload the `PS03.Rmd` file to RStudio Cloud. 
* Complete the problem set.
* Submit the resulting `PS03.html` file on [Moodle](https://moodle.smith.edu/course/view.php?id=35357){target="_blank"}. Note: you are only submitting the output HTML report file `PS03.html` and not the original `PS03.Rmd` R Markdown file.
...
<!--
## 3. Solutions & (imperfect) rubric {#PS03_R_solutions}

**Solution**:

* <a href="static/PS/PS03_solutions.Rmd" download>`PS03_solutions.Rmd`</a> "source code" to create html report output. 
* Resulting [`PS03_solutions.html`](static/PS/PS03_solutions.html){target="_blank"} output.
