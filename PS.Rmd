...
1. **GitHub frustrations are normal.** Git and GitHub are extremely powerful tools, but they can be very frustrating at times. This normal. Check out the title of this [zine](https://gumroad.com/l/oh-shit-git){target="_blank"} made by [Julia Evans](https://twitter.com/b0rk?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor){target="_blank"} for advanced users.
...
1. Install GitHub on your computers and set it up. Read and perform all steps in:
    + ~~Chapter 4: Register a GitHub account~~ You've already done
    + ~~Chapter 5: Install or upgrade R and RStudio~~ You've already done
    + Chatper 6: Install Git
    + Chapter 7: Introduce yourself to Git
1. "Clone" the GitHub repository you created in Lec32 into RStudio on your computer. If you were not in class that day, get caught up with a peer.  Read and perform all steps in:
    + Chapter 12: Connect RStudio to Git and GitHub.
    + **Section 12.2**: Ignore what's in the book and do the following:
        1. You will not "Make a repo on GitHub," but rather use the one you created in Lec32 [here](https://github.com/192-2019-09-Fall). 
        It should be named something like `learning-github-YOUR_GITHUB_USER_NAME`. So for example, my repo would is called `learning-github-rudeboybert`.
        1. Click big green button "Create repository."
