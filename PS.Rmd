...
1. "Clone" the GitHub repository you created in Lec32 into RStudio on your computer. If you were not in class that day, get caught up with a peer.  Read and perform all steps in:
    + Chapter 12: Connect RStudio to Git and GitHub. **For Section 12.2** ignore what's in the book and do the following:
        1. You will not "Make a repo on GitHub," but rather use the one you created in Lec32 [here](https://github.com/192-2019-09-Fall){target="_blank"}. 
        It should be named something like `learning-github-YOUR_GITHUB_USER_NAME`. So for example, my repo would be called `learning-github-rudeboybert`.
