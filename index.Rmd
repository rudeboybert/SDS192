...
* London underground: [Actual map](https://countryofnowhere.files.wordpress.com/2013/06/london_underground_full_map.png) vs [transit map](https://www.theverge.com/2015/11/11/9712376/london-walk-tube-underground-map)
...
* `sf` package for static maps in `ggplot2`. See [Spatial Data Science](https://keen-swartz-3146c4.netlify.com/){target="_blank"}.
