...
* Members of the [Smith College Spatial Analysis Lab](http://www.science.smith.edu/sal/){target="_blank"} will be making a brief presentation on Monday.
...
1. Example solutions to `examples.Rmd` Section 1 exercise.
1. Shapefiles
<!--
...
-->
1. Recap of data sources we've been converting to `sf` data objects so far
...
1. Go over solutions to Exercise 1 and code for Exercise 2. This is direct practice for PS06.
