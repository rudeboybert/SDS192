...
* RMarkdown: 1. **Bonus**: Play around with different formatting tools in R Markdown to customize your report! Go to RStudio menu bar -> Help -> Markdown quick reference.
...
* Problem Set 02 due next Monday 5pm, will be posted under [Problem Sets](PS.html) after class
...
1. **Method 3: Only if you are a macOS user**:
