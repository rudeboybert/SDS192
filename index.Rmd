...
* GitHub: Theory and terminology
    + What is git?
    + What is github
    + Lingo: repo (RStudio Project), clone, pull, commit/push, local vs remote
    + Important files: README.md, .gitigore, (.Rproj)
    + On GitHub.com: issues, pull requests, 
    + Exercise: For now, using GitHub GUI. Later we're going to connect to RStudio
    


### 2. In-class exercise

* reprex posted to README.md?
