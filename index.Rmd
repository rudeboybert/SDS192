...
Today you'll be building your own R Markdown Website and deploying it to the web on [netlify.com](https://www.netlify.com/){target="_blank"}.

1. Setup the example webpage I've given you, which is based off this course webpage
...
1. Deploy your R Markdown Website
    + Go to [app.netlify.com/drop](https://app.netlify.com/drop){target="_blank"}
