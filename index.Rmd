...
* https://www.signupgenius.com/go/5080f4eaaa62ba4fd0-spring1
* 
...
* Added "Tips & Tricks" tab to menubar of course webpage
...
* Biennial (every two years) graduate school panel
...
* `coord_cartesian(ylim=c(40, 60))` zooms in on the the y-axis to be between `a` to `b` but does not "clip" the points outside this interval
