...
* If you still need a Final Project Group, Slack DM me with your Section number.
* PS07 due on Friday. Start early! Also, I added a [hint](PS.html#PS07hint). 
* No office hours on Friday: the SDS faculty have a curriculum meeting.
...
* Setup a new connection" as shown in Slide 13 of this [slide deck](https://beanumber.github.io/sds192/lectures/29-sql.html#connect-pw-rememberpi)
...
* Run the 10 individual code segments delineated by `/*SQL comments*/` one at a time by highlighting them and clicking the `r emo::ji("lightning")` button.
