...
* Yingke's observation about "tidy" data using the example from the [Wide and narrow data](https://en.wikipedia.org/wiki/Wide_and_narrow_data){target="_blank"} Wikipedia page.


### 2. In-class exercise

1. Sec01: Visit from Smith GIS Lab at 11:30am
