...
* Install `fec16` package
* Discuss [Mini-Project 2](projects.html#MP2) in full detail

<!--
- Open General and give feedback on Spinelli
- code on random
- Pizza fund
- Slack how to write code
- you can message me on weekend if you want, I just won't respond
-->
...
* What is pseudocode?
* Types of joins: Copy this to your classnotes
...
Complete ModernDive Learning Check 3.20: Using data in `nycflights13` package, compute available seat miles for each airline separately:
