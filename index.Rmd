...
library(tidyverse)
library(janitor)
data_frame_with_ugly_names <- tibble(
  `asdf ?!? qwerty%` = c(1, 2),
  variable.name = c(2,1)
)
data_frame_with_ugly_names
data_frame_with_clean_names <- data_frame_with_ugly_names %>% 
  clean_names()
data_frame_with_clean_names


library(gapminder)
gapminder2007 <- gapminder %>% 
  filter(year == 2007, continent %in% c("Africa", "Asia"))
...
library(skimr)
gapminder2007 %>% skim()
gapminder2007 %>% group_by(continent) %>% skim()
```
