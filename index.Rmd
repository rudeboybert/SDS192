...
* Trend lines. Two types:
    + Linear regression
    + [LOWESS](https://www.statisticshowto.com/lowess-smoothing/#:~:text=LOWESS%20(Locally%20Weighted%20Scatterplot%20Smoothing,between%20variables%20and%20foresee%20trends.): Locally Weighted Scatterplot Smoothing
...
* Go over ModernDive reading in schedule above
* Copy this to your `classnotes.Rmd` and go over the code
