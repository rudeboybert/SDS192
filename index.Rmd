...
* Everyone open Slack at the start of lecture
    + Check for DM's
    + Check `#midterm` channel
* Update to office hours on syllabus 
* In order to not disadvantage students who take the midterm earlier
    + I won't be answering any Slack `#questions` after 3pm today
    + I've instructed the Friday Spinelli tutor not to answer questions.
the midterm earlier.
* Discussion on managing group dynamics for MP1
