...
* Poll on reading pace
* Explain RStudio Cloud vs Desktop
* Keep a single workspace for all your course notes, not a new one for each lecture
* Investigate issue with RStudio Cloud being slow.
* Start RMarkdown!
