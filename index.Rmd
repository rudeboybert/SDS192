...
<!--
* Recap of boxplots.
    + Sec01: ignore dashed blue line
    + Explain IQR = measure of spread. Also that role of 1.5 x IQR is to determine what points are outliers and what are not.
    + Show points vs boxplot
* Barplots.
    + Distribution of categorical variable
    + Two cases of geom: when categorical varible is pre-counted and when it is not.
