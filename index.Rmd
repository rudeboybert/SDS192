...
<!--
* Reminder to check in with me if you need to leave lecture early.
* Mid-semester feedback survey
* Look at tips and tricks page on course webpage.
* https://www.signupgenius.com/go/5080f4eaaa62ba4fd0-spring1
-->

* Sit next to your MP2 partner
* Joint SDS/PSY faculty member Randi Garci will be Honored with [Sherrerd Prize teaching award](https://www.smith.edu/news/sherrerd-2019-oct){target="_blank"} today 4:30pm in Campus Center Carroll Room. Please attend!
...
<!--
* Solutions to PS05:
    + Difference between `ylim(40, 60)` and `coord_cartesian(ylim=c(40, 60))`
    + 
-->
