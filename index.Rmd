...
* DataCamp background:
    + Show demo
    + Show courses
* [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfnVDe8p2bHgAqROGP4zb304fZWP9kkwrif6Jn4SzsxCl5KGQ/viewform){target="_blank"}
-->
...
<!--
* [R Markdown websites](https://rmarkdown.rstudio.com/lesson-13.html){target="_blank"}
    + Inputs: `.Rmd` and `_site.yml` files
    + Output: webpage in `docs/` folder, in particular `index.html` mainpage
...
* Sign into <https://app.netlify.com/> using your GitHub account
* Play around with R Markdown Websites
* When you're done, _deploy_ your website by using netlify's drag-and-drop interface <https://app.netlify.com/drop>. Later on, you can sync with GitHub
-->
