...
> Massive shout out to [Dr. Jenny Smetzer](https://www.smith.edu/academics/faculty/jennifer-smetzer){target="_blank"}, Lecturer in Statistical & Data Sciences, for her work setting this up!
...
```{r}
movies <- read_csv("https://rudeboybert.github.io/SDS192/static/movies.csv") %>% 
...
# How do I compute proportions? {#prop}
