...
**Hint**: See examples in [Precedence of Logical Operators](https://chortle.ccsu.edu/Java5/Notes/chap40/ch40_16.html){target="_blank"}.
...
Recreate the above visualization *exactly*, right down to the colors of the lines which were manually set to be `"forestgreen"` and `"orange"` and the capitalization of all text. However this time, the 
