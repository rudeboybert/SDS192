...
Choose groups of 2-3 members then fill in your group information in the Google Sheet in the `#final_project` Slack channel.

## Deliverable

* Use any data of your choosing
* Must be an R Markdown Website
...
1. **Individually**: Fill out the exit survey [Google Form](){target="_blank"}
