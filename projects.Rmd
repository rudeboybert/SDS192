...
To be posted on Monday, including information on what's required, the type of question you'll be answering, etc.



## To submit

1. **The group leader**: Each team will make only one submission. Specifically, the group leader will submit a `.zip` file of all the contents of the MP2 folder on moodle.
