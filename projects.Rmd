...
1. Everyone: Submit the following three files on Moodle:
    a) The `.ics` calendar file with your partner's calendar data.
...
1. Group leader only: Submit the joint reflection piece of no more than 500 words in PDF format. Suggest you write it in Google Docs and then export to PDF.
