...
You will work with a partner to analyze Federal Election Commission data and report your findings in a short writeup. These data come from the [Federal Election Commission](http://www.fec.gov/finance/disclosure/ftpdet.shtml#archive_link) and are based on the 2011--2012 federal election cycle. Be sure to read the [supporting documentation for these data](http://www.fec.gov/finance/disclosure/ftpdet.shtml#archive_link){target="_blank"}
...
* **Tips**:
    ...
    1. Knit early and knit often. For example:
        + If you add 5 lines of code and the document doesn't knit, you can easily locate the error.
        + If you add 500 lines of code and the document doesn't knit, you'll have a harder time locating the error.
...
1. **The group leader**: Will make a single submission on behalf of the team on moodle: A .zip file of all the contents of the MP2 folder. 
...
Designate a team leader who will do the following:
