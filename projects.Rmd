...
* +1 for an `.Rmd` that compiles without errors and is replicable and reproducible by someone else.
...
* +1 for readable, well-documented code (i.e. appropriate comments, using line breaks, breaking code up into logical chunks) that is human legible. 
* +1 for including a catchy and/or engaging title
* +2 for all group members completing the Individual Google Form
