...
1. Both group members: 
    a) The `.ics` calendar file with your partner's calendar data. You should both be logging at least 10 days worth of calendar data.
    a) The `.Rmd` R Markdown file analyzing your partner's calendar data.
    a) The `.pdf` output file
